...
class Wav2Vec2AsrRecipe(TrainRecipe):
    ...
    def create_trainer(self, context: RecipeContext) -> Trainer:
        ...
        # ====================================================================
        # Apply custom LoRA (from lora.py)
        # ====================================================================
        ...
        log.info("Applying custom LoRA to the model (q_proj, v_proj).")
        get_lora_model(context.model.base_module, lora_config)
        print_trainable_parameters(context.model.base_module)
