...
If you want to use own pathes for those checkpoint you've already downloaded, please edit the config file `src/omnilingual_asr/cards/models/rc_models.yaml` then install through
